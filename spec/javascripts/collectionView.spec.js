describe("collection view", function(){
  ...
  var ItemView = Backbone.Mario.ItemView.extend({
    tagName: "span",
    render: function(){
  ...
  var CollectionView = Backbone.Mario.CollectionView.extend({
    itemView: ItemView,
  ...
  describe("when rendering a collection view with no `itemView` specified", function(){
    var NoItemView = Backbone.Mario.CollectionView.extend({
    });
  ...
  describe("when providing a custom render that adds children, without a collection object to use, and removing a child", function(){
    ...
    var EmptyView = Backbone.Mario.ItemView.extend({
      render: function(){}
    });
  ...
  describe("when closing a collection view", function(){
    var EventedView = Backbone.Mario.CollectionView.extend({
      itemView: ItemView,
  ...
  describe("when override appendHtml", function(){
    var PrependHtmlView = Backbone.Mario.CollectionView.extend({
      itemView: ItemView,
  ...
  describe("when a child view triggers default events", function(){
    ...
    beforeEach(function(){
      collectionView = new CollectionView({
        itemView: Backbone.Mario.ItemView.extend({
  ...
  describe("when a child view is added to a collection view, after the collection view has been shown", function(){
    ...
    var ColView = Backbone.Mario.CollectionView.extend({
      itemView: ItemView,
      onShow: function(){}
    });
  ...
  describe("when setting an itemView in the constructor options", function(){
    ...
    beforeEach(function(){
      ...
      var cv = new Mario.CollectionView({
        itemView: IV,
        collection: c
      });
