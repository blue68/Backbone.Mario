describe("composite view", function(){
  ...
  describe("when a composite view has a template without a model", function(){
    ...
    var CompositeViewNoModel = Backbone.Mario.CompositeView.extend({
      itemView: ItemView,
  ...
  describe("when a composite view has a model and a template", function(){
    ...
    var CompositeView = Backbone.Mario.CompositeView.extend({
      itemView: ItemView,
  ...
  describe("when rendering a composite view twice", function(){
    ...
    var CompositeModelView = Backbone.Mario.CompositeView.extend({
      itemView: ItemView,
      template: "#composite-template"
    });
    ...
    beforeEach(function(){
      ...
      spyOn(Backbone.Mario.Renderer, "render");
    ...
    it("should re-render the template view", function(){
      expect(Backbone.Mario.Renderer.render.callCount).toBe(2);
    });
  ...
  describe("when rendering a composite view with no model, using a template to create a grid", function(){
    ...
    // A Grid Row
    var GridRow = Backbone.Mario.ItemView.extend({
      tagName: "tr",
      template: "#row-template"
    });

    // The grid view
    var GridView = Backbone.Mario.CompositeView.extend({
      tagName: "table",
  ...
  var TreeView = Backbone.Mario.CompositeView.extend({
    tagName: "ul",
