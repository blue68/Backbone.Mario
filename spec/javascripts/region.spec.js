describe("region", function(){
  ...
  describe("when a view is already closed and showing another", function(){
    ...
    var MyView = Backbone.Mario.View.extend({
      render: function(){
        $(this.el).html("some content");
      }
    });
  ...
  describe("when initializing a region manager and passing an 'el' option", function(){
    ...
    beforeEach(function(){
      el = "#foo";
      manager = new Backbone.Mario.Region({
        el: el
      });
    });
  ...
  describe("when creating a region instance with an initialize method", function(){
    ...
    beforeEach(function(){
      ...
      Manager = Backbone.Mario.Region.extend({
        el: "#foo",
  ...
  describe("when removing a region", function(){
    ...
    beforeEach(function(){
      ...
      MyApp = new Backbone.Mario.Application();
      MyApp.addRegions({
        MyRegion: "#region", 
  ...
  describe("when resetting a region", function(){
    ...
    beforeEach(function(){
      ...
      region = new Backbone.Mario.Region({
        el: "#region"
      });
